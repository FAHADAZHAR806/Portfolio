...
export default function Address() {
  ...
  return (
    <>
      <div
        data-aos="fade-up"
        className="grid gap-4 lg:grid-cols-3 max-w-5xl  m-auto bg-[#161616] text-white my-10 sm:py-10 justify-items-center sm:px-16 "
      >
        <div
          data-aos="fade-up"
          className=" grid grid-cols-1 justify-items-center border-1 border-white p-6 rounded-xl gap-2 w-60"
        >
          <div className="grid grid-cols-1 rounded-4xl justify-items-center w-8 bg-[#F50D32]  h-8 p-2">
            <img src="/images/message.svg" alt="" />
          </div>
          <p className=" text-center" onClick={handleEmailClick}>
            {email}
          </p>
        </div>
        <div
