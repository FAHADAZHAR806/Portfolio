...
export default function Projects() {
  return (
    <>
<div data-aos="fade-up"  className="grid grid-cols-3  w-full max-w-7xl py-10 px-10 bg-[#161616] gap-4 m-auto">
 {Project.map((item,index)=>(
  <div key={index} className='bg-[#2E2E30] text-white bg- grid grid-cols-1 justify-items-start gap-4 py-10 px-10 border-2 rounded-md  w-full h-full'> 
  <div>
