    ...
    <>
      ...
      <div data-aos="fade-up" className="grid justify-items-center gap-4 max-w-5xl m-auto my-4 sm:grid-cols-1 sm:justify-items-center lg:grid-cols-3 lg:justify-items-center lg:py-10 ">
        {Testimonials.map((item, index)=>(
           <div key={index} data-aos="fade-up" className="grid grid-cols-1  text-amber-50 border-2 border-amber-50 w-70 py-10   rounded-2xl justify-items-center">
           ...
           <div className="py-2">
             ...
             <img src={item.img} className="w-24 h-24 rounded-full object-cover  " alt="William-Roy.jpg" />
