  ...
  const ServiceData = [
    {
      title: "Custom Design",
      icon: FaLaptopCode,
      content:"Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aliquam, molestias rem. Voluptas mollitia ratione deleniti illum! Odio voluptatum, saepe exercitationem consequatur hic error eius iure deserunt vitae! Ea, quae quod",
  ...
  return (
    <>
      ...
      {ServiceData.map((item, index)=>(
         <div key={index} data-aos="fade-up" className='grid grid-cols-1 gap-10 text-white '>
          <div className=" rounded-2xl grid grid-cols-1 justify-items-center  w-8 h-8">
          <item.icon size={40} className="text-white bg-[#2E2E30] py-3 rounded-full " />
