  ...
  return (
    <>
     ...
     {CardData.map((item, index) => (
        <div key={index} data-aos="fade-up" className="card grid grid-cols-1 gap-2 text-amber-50 border-2 border-amber-50 w-80 h-full py-10 px10 rounded-2xl justify-items-center">
          ...
          <button className={` grid grid-rows-1 justify-items-start border-2 border-amber-50 py-2 px-4 rounded-xl
            ${index === 1 ? "bg-[#F50D32] " : "bg-[#161616]"}`} >{item.buttonText}</button>
