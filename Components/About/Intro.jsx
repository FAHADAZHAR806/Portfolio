...
export default function Intro() {
 const paragraphs = ["Software Engineer", "Front End Web Developer"];
  ...
  return (
    ...
    <>
 <div data-aos="fade-up" className="intro grid   gap-20  max-w-5xl m-auto p-4 mt-8   justify-items-center   sm:grid-cols-1 lg:grid-cols-2 lg:gap-0 lg:py-20 lg:px-2 " >
