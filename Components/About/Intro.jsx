...
export default function Intro() {
  return (
    <>
 <div className="intro grid   gap-20  max-w-5xl m-auto p-6 mt-8   justify-items-center   sm:grid-cols-1 lg:grid-cols-2 lg:gap-0 lg:py-20 lg:px-0 " >


 <div className='bg-neutral-600 w-74 mx-3 sm:mx-0  sm:w-78 sm:h-98'>
        
        
        <div className='w-76 float-left h-full -my-4 -ml-2 '  >
          
          <img src="/images/bg-white.svg" alt="" className='w-full h-full relative'  /> </div>
          <img src="/images/Design.svg" alt="" className='float-left -mt-90 -ml-6 sm:-ml-8 sm:-mt-100'/>
