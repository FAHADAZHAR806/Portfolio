...
export default function Intro() {
  ...
  return (
    <>
      <div
        data-aos="fade-up"
        className="intro grid   gap-20  max-w-5xl m-auto p-4 mt-8   justify-items-center   sm:grid-cols-1 lg:grid-cols-2 lg:gap-0 lg:py-20 lg:px-2 "
      >
        ...
        <div className=" grid grid-col-1 gap-6 text-[#FFFFFF] ">
          ...
          <p className="text-2xl">
            I'm <span className="text-[#f57d0dc0] pr-2">{displayText}</span>
          </p>
          <p className="pr-4">
          ...
          <button className="rounded-2xl bg-[#F50D32] w-40 h-10 ">
            {" "}
