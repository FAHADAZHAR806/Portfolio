  ...
  return (
    <>
      ...
      {Institute.map((item,index)=>(
        <div key={index}  className="w-[280px] h-[280px] my-2 grid grid-cols-2 items-center text-white text-center px-4 py-6 border-1 border-white bg-[#2E2E30]">
          <div className="grid items-center"> <img src={item.logo} className="  w-full h-full " alt="institute.png" loading="lazy" /></div>
         <div >
          <h1 >{item.Name}</h1>
